...
enum BrilliantNotificationType {
  ...
  CLIMATE_ALERT_WATER_DETECTED = 13, // DEPRECATED
  MESH_DEVICE_UPDATE_SCHEDULED = 14, // DEPRECATED
  MESH_DEVICE_UPDATE_IN_PROGRESS = 15, // DEPRECATED
  NEST_UPDATE = 16,
  SALTO_KS_CODE_REQUIRED = 17, // DEPRECATED
  CONTROL_TRACKED_RELEASE_STAGES_DIFFER = 18,
  ALEXA_HOME_SKILL_AUTO_ENABLE = 19,
  SMARTTHINGS_API_MIGRATION = 20, // DEPRECATED
  INTEGRATION_DEAUTHORIZED = 21,
  WATER_SHUTOFF_VALVE_STATUS_ERROR = 22,
  WATER_SHUTOFF_VALVE_LEAK_DETECTION_ERROR = 23,
  CLIMATE_ALERT_LOW_HUMIDITY = 24,
}
