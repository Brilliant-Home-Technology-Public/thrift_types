...
enum MeshProvisionStatus {
  ...
  PREPARING_FOR_PROVISIONING
  ERROR_REMOVING_OLD_PERIPHERAL
  SCANNING_FOR_UNPROVISIONED
  SCAN_FOR_UNPROVISIONED_TIMEOUT
  CONNECTING_TO_UNPROVISIONED
  CONNECTED_TO_UNPROVISIONED
  GETTING_UNICAST_ADDRESS
  PROVISIONING_SETUP_FAILED
  IDENTIFY_NODE
  PROVISIONING_NODE
  PROVISIONING_COMPLETE
  PROVISION_FAILED
  SCANNING_FOR_PROVISIONED
  SCAN_FOR_PROVISION_TIMEOUT
  CONNECTING_TO_PROVISIONED
  CONNECTED_TO_PROVISIONED
  VERIFYING_NET_KEY
  VERIFYING_APP_KEY
  BINDING_MODEL_APP_KEYS
  SETTING_PUBLISH_ADDRESS
  SETUP_COMPLETE
  SETUP_TIMEOUT
  SETUP_FAILED
  ADDING_TO_BRILLIANT_MESH
  CONFIGURING_BLE_MESH_PERIPHERAL
  CONFIGURING_SWITCH_CONFIG
  AUTOMATIC_CONFIGURATION_PUSH
  SUCCESSFULLY_ADDED_TO_BRILLIANT
  FAILED_TO_ADD_TO_BRILLIANT
  NOT_STARTED
