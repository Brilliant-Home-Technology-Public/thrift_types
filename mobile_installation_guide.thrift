...
const string MOBILE_GUIDE_FIELD_MISSING_GANGBOX_PERIPHERAL_PREFIX = "field_missing_gangbox_perihperal_"
...
const string MOBILE_GUIDE_SCREEN_DEVICE_SETUP_LIGHT_TYPE_PREFIX = "screen_device_setup_light_type"
