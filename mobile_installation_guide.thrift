...
enum MeshProvisionStatus {
  ...
  AUTOMATIC_CONFIGURATION_FINISHED = 58 // Added 03/2024 to signify beginning of user input required
...
enum GuideScreenType {
  ...
  // DEVICE_SETUP_FORWARDING = 8 - Deprecated 23.02.23
  WARNING_SCREEN = 9
  ROOM_SELECTION = 10
  FREE_PAIRING = 11
...
const string MOBILE_GUIDE_COMPUTED_TEXT_INTEGRATION_NEXT = "COMPUTED_INTEGRATION_NEXT"
...
const string MOBILE_GUIDE_FIELD_FACEPLATE_SOC = "field_faceplate_soc"
const string MOBILE_GUIDE_FIELD_FADE_IN_REQUIRED_PREFIX = "field_fade_in_required_"
...
const string MOBILE_GUIDE_FIELD_INTEGRATION_DEVICE_NAME = "field_integration_device_name"
const string MOBILE_GUIDE_FIELD_INTEGRATION_ID = "field_integration_id"
const string MOBILE_GUIDE_FIELD_INTEGRATION_SERIALIZED_PERIPHERAL_INFOS = "field_integration_serialized_peripheral_infos"
const string MOBILE_GUIDE_FIELD_INTEGRATION_SERIALIZED_SETUP_IDS = "field_integration_serialized_setup_ids"
...
const string MOBILE_GUIDE_FIELD_MAX_INTENSITY_POWER_READING_PREFIX = "field_max_intensity_power_reading_"
...
const string MOBILE_GUIDE_FIELD_SERIALIZED_PERIPHERAL_INFO = "serialized_peripheral_info"
...
const string MOBILE_GUIDE_FIELD_SKIP_SOFTWARE_INTEGRITY_CHECK = "field_skip_software_integrity_check"
const string MOBILE_GUIDE_FIELD_SOFTWARE_INTEGRITY_INVALID = "field_software_integrity_invalid"
...
const string MOBILE_GUIDE_SCREEN_FADE_IN_REQUIRED = "screen_fade_in_required"
...
const string MOBILE_GUIDE_SCREEN_SKIP_FOR_NOW_ADD_THIRD_PARTY = "screen_skip_for_now_add_third_party"
const string MOBILE_GUIDE_SCREEN_SKIP_FOR_NOW_LED_LEVEL_PREFIX = "screen_skip_for_now_led_level_"
const string MOBILE_GUIDE_SCREEN_SKIP_FOR_NOW_RECONFIGURE_LOADLESS_SLIDERS = "screen_skip_for_now_reconfigure_loadless_sliders"
const string MOBILE_GUIDE_SCREEN_SKIP_INSTALL = "screen_skip_install"
const string MOBILE_GUIDE_SCREEN_SOFTWARE_INTEGRITY_WARNING = "screen_software_integrity_warning"
...
const string MOBILE_GUIDE_URL_ACCEPT_SECURITY_RISK = "brl://guide/acceptSecurityRisk"
