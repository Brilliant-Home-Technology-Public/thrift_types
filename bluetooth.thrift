...
enum SwitchPropertyID {
  ...
  TUNE_ZC_NUM_PT_FOR_NS_RED   = 0x25,
  TUNE_MAX_DEV_BTW_RUNS       = 0x26,
  REBOOT                      = 0x27,
...
const map<SwitchPropertyID, SwitchPropertySpec> SWITCH_PROPERTY_SPECS = {
  ...
  SwitchPropertyID.TUNE_ZC_NUM_PT_FOR_NS_RED: {
    "property_id": SwitchPropertyID.TUNE_ZC_NUM_PT_FOR_NS_RED,
    "property_size": 2,
    "default_value": 0,
    "variable_name": "",
  },
  SwitchPropertyID.TUNE_MAX_DEV_BTW_RUNS: {
    "property_id": SwitchPropertyID.TUNE_MAX_DEV_BTW_RUNS,
    "property_size": 2,
    "default_value": 0,
    "variable_name": "",
  },
