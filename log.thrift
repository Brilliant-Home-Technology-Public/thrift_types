...
const string UI_BUTTON_NAME_ADD_SALTO_KS = "add_salto_ks_brands"
...
const string UI_BUTTON_NAME_DISARMED_STATE_WIDGET_DISARMED_BYPASS = "disarmed_state_widget:disarmed_bypass”
